const  canvasStyle = () =>
{
    ...
    const window_scrolling = () =>
    {
        ...
        {
            text.style.cssText += `transform: translate(-50% , -${50 + window.scrollY / 10}%) scale(${1 + (window.scrollY / 500)});`;
            text.style.cssText += `top: ${50 + window.scrollY / 10}%`;
            ...
            {
            text.style.cssText += `transform: translate(-50% , -50%) scale(${1});`;
